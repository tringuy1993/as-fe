...
export default function TimeGamma() {
  ...
  params["all"] = false
  const key_params = {"ES": ES_URL, "$SPX.X": ALL_URL, 
  "SPY": ALL_URL, "$VIX.X": ALL_URL, 
  "$NDX.X": ALL_URL, "QQQ": ALL_URL,}
  ...
  return (
      <main className="">
        ...
        <EChartTime symbol={selectTicker} data={modified_data} greek={selectedGreek}/>
      </main>
    )
  }